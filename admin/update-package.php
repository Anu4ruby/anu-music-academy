...
$sql="update tblmusicpackages set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails where PackageId=:pid";
...
<html>
<head>
<title>AMA | Admin Package Creation</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Music Package </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Package Price per class in USD</label>
									<div class="col-sm-8">
