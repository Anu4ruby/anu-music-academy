...
<html>
<head>
<title>AMA | Admin manage Issues</title>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/AMA/admin/updateissue.php?iid=<?php echo ($result->id);?>');">View </a>
</td>
